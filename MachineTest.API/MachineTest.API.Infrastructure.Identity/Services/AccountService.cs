...
using MachineTest.API.Application.Exceptions;
...
using MachineTest.API.Infrastructure.Identity.Helpers;
...
namespace MachineTest.API.Infrastructure.Identity.Services
{
