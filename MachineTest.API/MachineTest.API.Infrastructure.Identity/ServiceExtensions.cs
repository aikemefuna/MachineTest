...
using MachineTest.API.Infrastructure.Identity.Contexts;
using MachineTest.API.Infrastructure.Identity.Models;
using MachineTest.API.Infrastructure.Identity.Services;
...
namespace MachineTest.API.Infrastructure.Identity
{
